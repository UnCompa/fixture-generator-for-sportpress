...
**Feature 8.1: Listado de Fixtures Generados**
- Ver todos los fixtures creados por grupo/torneo
- Editar fechas individuales
- Eliminar jornadas completas

**Feature 8.2: Regeneración Inteligente**
- Botón "Regenerar" con opciones:
  - Mantener fechas existentes, solo reordenar
  - Regenerar todo desde cero
  - Regenerar solo jornadas futuras
